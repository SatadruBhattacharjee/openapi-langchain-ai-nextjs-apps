import { ChatMessage, useAppConfig, useChatStore } from '@chat/store';
import Locale from '@chat/locals';
import styles from './exporter.module.scss';
import { List, ListItem, Modal, Select, showToast } from './../ui-lib/ui-lib';
import { IconButton } from '../button';
import { downloadAs } from '@chat/utils';
...
import {
  MessageSelector,
  useMessageSelector,
} from '../message-selector/message-selector';
import { Avatar } from '../emoji/emoji';
import dynamic from 'next/dynamic';
import NextImage from 'next/image';

import { toBlob, toJpeg, toPng } from 'html-to-image';
import { DEFAULT_MASK_AVATAR } from '@chat/store';
import { api } from '@chat/store';
import { prettyObject } from '@chat/utils';
import { EXPORT_MESSAGE_CLASS_NAME } from '@chat/constant';
    ...
    <div className={styles['image-previewer']}>
      ...
      >
        <div className={styles['chat-info']}>
          ...
          <div>
            <div className={styles['main-title']}>Enterprise ChatGPT</div>
            <div className={styles['sub-title']}>
              https://github.com/SatadruBhattacharjee/openapi-langchain-ai-nextjs-apps
            </div>
