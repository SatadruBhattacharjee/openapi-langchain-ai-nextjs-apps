...
import { getCSSVar } from '@chat/utils';

import dynamic from 'next/dynamic';
import { Path, SlotID } from '@chat/constant';
...
const NewChat = dynamic(
  async () => (await import('../new-chat/new-chat')).NewChat,
  {
    loading: () => <Loading noLogo />,
  }
);

const MaskPage = dynamic(async () => (await import('../mask/mask')).MaskPage, {
  loading: () => <Loading noLogo />,
});
